...
class VilaLlamaForCausalLM(LlavaMetaModel, LlavaMetaForCausalLM, PreTrainedModel):
    def __init__(self, 
        ...
        self.init_vlm(config, group_size, sampling_params, quant_config, kv_cache_config, quant_path)
    
    def init_vlm(self, config, group_size, sampling_params, quant_config, kv_cache_config, quant_path, *args, **kwargs):
        ...
        self.llm = LlamaForCausalLM(llm_cfg, group_size, sampling_params, quant_config, kv_cache_config, quant_path=None)
