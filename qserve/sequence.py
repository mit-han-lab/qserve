...
class SequenceData:
    ...
    def get_kv_scales(self) -> torch.Tensor:
        assert hasattr(self, "kv_scales")
...
class Sequence:
    ...
    def allocate_kv_scales(
        ...
        # 2 for k and v, kv scales is part of the sequence data
        self.data.kv_scales = torch.empty(
            2, num_layers, num_tokens, num_heads, dtype=torch.float16, device=device
        )
