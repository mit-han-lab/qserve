...
def init():
    global max_seq_len, llama_multiple_of, mem_efficient_load
    max_seq_len = 8192
    ...
    # LLaVA Constants
    global LLAVA_IGNORE_INDEX, LLAVA_DEFAULT_IMAGE_TOKEN, LLAVA_DEFAULT_IMAGE_TOKEN_IDX, LLAVA_DEFAULT_TOKEN_PER_IMAGE, LLAVA_DEFAULT_IMAGE_PATCH_TOKEN, LLAVA_DEFAULT_IMAGE_PATCH_TOKEN_IDX, LLAVA_DEFAULT_IM_START_TOKEN, LLAVA_DEFAULT_IM_END_TOKEN, LLAVA_DEFAULT_IM_TOKEN_PLACE_HOLDER, AUTO_FILL_IM_TOKEN_HOLDER
    LLAVA_IGNORE_INDEX = -100
    LLAVA_DEFAULT_IMAGE_TOKEN = "<image>"
    LLAVA_DEFAULT_IMAGE_TOKEN_IDX = -200
    LLAVA_DEFAULT_TOKEN_PER_IMAGE = 196
